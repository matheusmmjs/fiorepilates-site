# Assets de marca gerados (não-fotográficos)

Catálogo das **imagens desenhadas** da Fiore (artes, cards OG, mockups). A regra é:
a **fonte editável é o SVG** em `assets/brand/`; o arquivo raster (JPG/PNG) é só a
exportação final. Para editar, mexa no SVG e re-exporte.
